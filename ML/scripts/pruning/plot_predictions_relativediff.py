...
data_path = "/lustre/aoc/projects/hera/tbilling/ml/pruning/"
results = sorted(glob.glob(data_path+"*_results_*.npy"))
fold = ["Fold 1","Fold 10","Fold 2","Fold 3","Fold 4","Fold 5","Fold 6","Fold 7","Fold 8","Fold 9"]
