...
# Image of the Simulation and Real Data Spectrum
    ...
    plt.plot(freq,np.ma.masked_equal(spect_simdata[0].data[0,:,sim_ra,sim_dec],0),'r.', label='Simulation')
    plt.plot(freq,np.ma.masked_equal(spect_realdata[0].data[0,:,ra,dec],0),'b.', label='Real Data')
    plt.xlabel("Freq [Mz]")
